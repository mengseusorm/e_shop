                        ...
                        <x-forms.post :action="route('frontend.auth.login')">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control" placeholder="{{ __('E-mail Address') }}" value="admin@admin.com" maxlength="255" required autofocus autocomplete="email" />
                                </div>
                            </div><!--form-group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="password" name="password" id="password" value="secret" class="form-control" placeholder="{{ __('Password') }}" maxlength="100" required autocomplete="current-password" />
                                </div>
                            </div><!--form-group-->
