            ...
            <x-slot name="body">
                <div>  
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="category_name" class="form-control" placeholder="{{ __('Name') }}" value="{{ old('name') }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="category_slug" class="form-control" placeholder="{{ __('Category slug	') }}" value="{{ old('category_slug') }}" maxlength="255" required />
                        </div>
                    </div><!--form-group-->   
                    <div class="form-group row">
                        <label for="email" class="col-md-2 col-form-label">@lang('Category slug	')</label> 
